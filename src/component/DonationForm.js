    ...
    <div className=' sticky top-14 z-10'>
      ...
      {isOpenForm ?
        <div className="w-[28rem] p-6 bg-white rounded-lg shadow-md">
          ...
          <button onClick={() => setIsOpenForm(false)} className='h-12 w-12 rounded-full bg-green-100 flex items-center justify-center mb-5 text-green-700 text-xs'>
          <ArrowLeft />
          </button>
          ...
          <form className="max-w-sm mx-auto">
            ...
            <div className='flex gap-3'>
              ...
              <div className="mb-5">
                <label for="email" className="block mb-2 text-sm font-medium text-gray-900 ">Your email</label>
                <input type="date" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="name@flowbite.com" required />
              </div>
        ...
        : <div className="w-[28rem] p-6 bg-white rounded-lg shadow-md">
          ...
          <div className="flex mb-4">
            <button
              className={`flex-1 py-2 px-4 rounded-l-lg ${donationType === 'once' ? 'bg-green-500 text-white' : 'bg-gray-200'
                }`}
            ...
            <button
              className={`flex-1 py-2 px-4 rounded-r-lg ${donationType === 'monthly' ? 'bg-green-500 text-white' : 'bg-gray-200'
                }`}
          ...
          <div className="grid grid-cols-3 gap-2 mb-4">
            {(donorType === 'foreign' ? foreignAmounts : indianAmounts).map((amount) => (
              <button
                key={amount}
                className={`py-2 px-4 rounded-lg border ${selectedAmount === amount ? 'bg-green-500 text-white border-green-500' : 'bg-white border-gray-300'
                  }`}
          ...
          <button
            className={`w-full py-3 px-4 text-white rounded-lg mb-2 transition-colors ${donorType === 'foreign' && !selectedCurrency
